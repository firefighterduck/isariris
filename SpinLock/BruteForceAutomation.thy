...
method open_inv=
  (rule upred_entails_substE[OF inv_acc[OF subset_UNIV, to_entailment]], rule fupd_frame_mono, iris_simp)
  | (rule upred_entails_trans[OF inv_acc[OF subset_UNIV, to_entailment]], rule fupd_mono, iris_simp)
...
method brute_force_hyp =
  ...
  intro!: pure_goal_lifting universal_elim_goal existential_elim_hyps upred_universal_wand normalize_hyps
    intro_rules fupd_elim_hyps bupd_elim later_elim_hyps(1,2) pure_hypothesis_lifting
